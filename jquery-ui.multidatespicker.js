...
(function( $ ){
	...
	$.fn.multiDatesPicker = function(method) {
		...
		function setWeekLinks() {              
            $(this[0].dpDiv).find("td.ui-datepicker-week-col").wrapInner('<a href="#"></a>');
        }
		...
		var methods = {
			init : function( options ) {
				...
				$this.on("click", ".ui-datepicker-week-col", function() {
					$(this).datepicker("selectWeek", 43);
				});
			...
			selectWeek: function ( week, type ) {
				if(!type) type = 'picked';
				this.multiDatesPicker.dates[type] = [];
				var fd = firstDayOfWeek(week);
				for (var i = 0; i < 7; i++)
					addDate.call(this, new Date(fd + i*(1000 * 60 * 60 * 24)), type, true);
